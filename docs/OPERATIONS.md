...
- temporary live-preview source loss should self-heal inside the running service; routine camera/network blips should not require reopening the NVR page to resume tiles
